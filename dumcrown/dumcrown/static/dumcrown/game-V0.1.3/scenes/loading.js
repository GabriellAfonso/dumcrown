...
export class Loading extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('morte_card', PATH + '/images/cards/monsters/card01.png');
        this.load.image('darkage1_card', PATH + '/images/cards/monsters/card02.png');
        ...
        this.load.image('cdc_card', PATH + '/images/cards/monsters/card05.png');
        this.load.image('skillet_card', PATH + '/images/cards/monsters/card06.png');
        this.load.image('kronos_card', PATH + '/images/cards/monsters/card07.png');
        this.load.image('okada_card', PATH + '/images/cards/monsters/card08.png');
        this.load.image('khras_card', PATH + '/images/cards/monsters/card09.png');
        this.load.image('smoothcriminal_card', PATH + '/images/cards/monsters/card10.png');
        this.load.image('boogie_card', PATH + '/images/cards/monsters/card11.png');
        this.load.image('spring_card', PATH + '/images/cards/monsters/card12.png');
        this.load.image('polaroid_card', PATH + '/images/cards/monsters/card13.png');
        this.load.image('maniac_card', PATH + '/images/cards/monsters/card14.png');
        this.load.image('crazy_card', PATH + '/images/cards/monsters/card15.png');
        this.load.image('theojays_card', PATH + '/images/cards/monsters/card16.png');
        this.load.image('neonb_card', PATH + '/images/cards/monsters/card17.png');
